...
export const RevisionGroup = ({
    ...
    const handleRestoreRevision = useCallback(
        async (documentId: string) => {
            const restoredDocument = documentsQuery?.data?.data.find(doc => doc.id === parseInt(documentId));
            const mainDocumentIndex = rows.findIndex((doc: DocumentType) => doc.revisionGroup === revisionGroup);
