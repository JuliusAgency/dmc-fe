...
import { useChildCategories } from "../../../../hooks/category/categoryHooks.ts";
...
export const AddDocument = ({
  ...
  const { data: categories } = useChildCategories();
        ...
        >
          ...
          >
            ...
            <GridInput
              ...
              disabled={Boolean(
                formData?.revisionGroup && documentToEdit?.revisionGroup
              )}
            />
            <GridMultipleAutocomplete
              multiple={false}
