export const PENDING_SIGNATURES_TITLE = "Documents Pending Your Signature";
export const NO_PENDING_SIGNATURES =
  "You have no documents waiting for signature.";
...
export const REJECT_DIALOG_CONFIRM = "Reject";
